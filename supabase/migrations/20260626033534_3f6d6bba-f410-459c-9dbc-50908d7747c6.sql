...
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.tenant_of(uuid) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.log_audit_event(text, text, text, jsonb, uuid) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
...
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.dsar_export_subject(uuid, text, text) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
...
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.record_consent_change(uuid, public.consent_channel, public.consent_status, text, text, public.consent_source, text, text) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.log_ai_action(uuid, text, text, text, text, uuid, uuid, text, text, text, jsonb, text) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.get_org_billing_card(uuid) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.admin_user_activity_summary() FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
DO $$ BEGIN EXECUTE 'REVOKE EXECUTE ON FUNCTION public.admin_user_activity_summary(uuid) FROM PUBLIC, anon, authenticated'; EXCEPTION WHEN undefined_function THEN NULL; END $$;
